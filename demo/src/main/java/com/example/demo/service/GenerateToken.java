...
public class GenerateToken {
     ...
     */
         ...
         * */
        private static final String PRIVATE_KEY_FILE_RSA = "users\\shandilyavedant\\Downloads\\VedTemp.pem";

        /** Placeholder helper string. */
        public static final String BEGIN_PRIVATE_KEY = "-----BEGIN PRIVATE KEY-----";
        public static final String BEGIN_PRIVATE_KEY_RSA = "-----BEGIN RSA PRIVATE KEY-----";


        /** Placeholder helper string. */
        public static final String END_PRIVATE_KEY = "-----END PRIVATE KEY-----";
        public static final String END_PRIVATE_KEY_RSA = "-----END RSA PRIVATE KEY-----";
...
//               File file = new File("/users/shandilyavedant/Downloads/VedTemp.pem");
//
//               try (InputStream in = Base64.getDecoder().wrap(new FileInputStream(file))) {
//                   int content;
...
//               }
//
//              InputStream fr = new FileInputStream("/users/shandilyavedant/Downloads/VedTemp.pem");
//               InputStream fr2= Base64.getDecoder().wrap(fr);
////               FileReader fr = new FileReader(
////                       "/users/shandilyavedant/Downloads/VedTemp.pem");
////
////               // Declaring loop variable
////               int i;
////               // Holds true till there is nothing to read
//               int i;
//               String pem2 = new String();
//               while ((i = fr2.read()) != -1){
//
//                   pem2 = pem2 + ((char) (i));
//                   System.out.print("ye lo"+ pem2);
//
//               }

//                    //Print all the content of a file
                //   System.out.print("ye lo"+ pem);
                File file = new File(
                        GenerateToken.class.getClassLoader().getResource("NewKey.pem").getFile()
                );
                String pem = new String(Files.readAllBytes(Paths.get(file.getPath())));
                System.out.println(pem);
                String privKey = pem.replace(BEGIN_PRIVATE_KEY, EMPTY).replace(END_PRIVATE_KEY, EMPTY);
//                privKey = privKey.replaceAll("\r", EMPTY);
//                privKey = privKey.replaceAll("\\s+", EMPTY);
//                privKey = privKey.replaceAll("\n", EMPTY);
//                System.out.println(privKey);
//                Base64.Decoder bs64 = Base64.getDecoder();
//                byte[] decodednew = bs64.decode(privKey);
//                System.out.println(decodednew);
                byte[] newcoded = org.apache.commons.codec.binary.Base64.decodeBase64(privKey);
...
//               System.out.println(decoded);
                ...
                PKCS8EncodedKeySpec spec = new PKCS8EncodedKeySpec(newcoded);
        ...
        public String generateToken(String appId, String tenantId,String roomName, String userName){
            try
            {
                ...
                String token = JaaSJwtBuilder.builder()
                        ...
                        .withApiKey(appId+"/"+tenantId) // Set the api key
                        .withUserName(userName)// Set the user name
                        .withUserEmail("ved@gmail.com") // Set the user email
                        ...
                        .withUserAvatar("") // Set the user avatar
                ...
                System.out.println("here we are in catch22");
